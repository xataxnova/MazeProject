...
namespace PureMVC.Core
{
    ...
    public class Controller: IController
    {
        ...
        {
            Func<ICommand> dummy_command;
            if (commandMap.TryGetValue(notificationName, out dummy_command) == false)
            {
        ...
        public virtual void RemoveCommand(string notificationName)
        {
            ...
            if (commandMap.TryRemove(notificationName, out dummy_command))
            {
